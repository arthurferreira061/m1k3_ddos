...
black_lists = ["pornhub.c0m", "anonboot.pw"]
...
def logo():
  ...
  (           )   ========================================================
 ( (  )   (  ) )     D4 - http flooder
(__(__)___(__)__) ===== Version: [ 2 ]''')
    try:
        print("\n[*] Cible : " +str(url_main)+ ":" +str(port))
    except:
        pass
    try:
        print("[*] Methodes : " +str(name_method_attack))
    except:
        pass
    try:
...
def start_port():
    ...
    if port == '':
        if "https" in url:
                port = int(443)
                print("[!] Port selectionner = 443 [!]")
        else:
            port = int(80)
            print("[!] Port selectionner = 80 [!]")
    else:
        port = int(port)
...
def choice_method_attack():
    ...
    print("-----------------------------")
    print("|_--> 1: Requete [ Normal ]")
    print("|_--> 2: Requete [  Spam  ]")
...
def numthreads():
    ...
    try:
        print("-----------------------------")
        threads = int(input("[*] Multiples [2000]: "))
    except ValueError:
        threads = int(2000)
